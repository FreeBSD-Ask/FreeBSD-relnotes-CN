...
[cdce(4)](https://man.freebsd.org/cgi/man.cgi?query=cdce&sektion=4&format=html) 驱动支持实现 USB Communication Device Class Ethernet Control Model (CDC ECM) 或
...
[cue(4)](https://man.freebsd.org/cgi/man.cgi?query=cue&sektion=4&format=html) 驱动支持基于 CATC USB-EL1210A 的 USB 以太网
适配器，包括：
...
[cxgbe(4)](https://man.freebsd.org/cgi/man.cgi?query=cxgbe&sektion=4&format=html) 驱动支持基于 T7 ASIC 的
...
[dtsec(4)](https://man.freebsd.org/cgi/man.cgi?query=dtsec&sektion=4&format=html) 驱动下工作：
...
[em(4)](https://man.freebsd.org/cgi/man.cgi?query=em&sektion=4&format=html) 驱动支持基于 Intel
...
[et(4)](https://man.freebsd.org/cgi/man.cgi?query=et&sektion=4&format=html) 驱动支持 Agere ET1310 10/100/Gigabit
以太网适配器。
...
[genet(4)](https://man.freebsd.org/cgi/man.cgi?query=genet&sektion=4&format=html) 驱动支持 树莓派 4 Model B 及相关系统上 Broadcom BCM2711
的以太网控制器部分。
它使用 BCM54213PE PHY。
...
[ice(4)](https://man.freebsd.org/cgi/man.cgi?query=ice&sektion=4&format=html) 驱动支持以下
...
**ice** 驱动支持此系列中具有 SFP28/QSFP28 cages 的部分适配器，
...
以下设备受
[ipheth(4)](https://man.freebsd.org/cgi/man.cgi?query=ipheth&sektion=4&format=html) 驱动支持：

* Apple iPhone tethering（所有型号）
* Apple iPad tethering（所有型号）

[ix(4)](https://man.freebsd.org/cgi/man.cgi?query=ix&sektion=4&format=html) 驱动支持 Intel 10Gb 以太网 PCIe 适配器，
包括：
...
[ixl(4)](https://man.freebsd.org/cgi/man.cgi?query=ixl&sektion=4&format=html) 驱动支持 Intel Ethernet 700 系列。
...
[kue(4)](https://man.freebsd.org/cgi/man.cgi?query=kue&sektion=4&format=html) 驱动支持基于 Kawasaki LSI KL5KLUSB101B 的 USB 以太网
适配器，包括：
