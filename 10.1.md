...
为 [camcontrol(8)](http://www.freebsd.org/cgi/man.cgi?query=camcontrol&sektion=8) 添加了一个新选项 `-b`，用于输出现有的总线及其父设备。[(r260177)](http://svn.freebsd.org/viewvc/base?view=revision&revision=260177)（由Netflix赞助）
