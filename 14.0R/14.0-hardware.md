...
[ti(4)](https://man.freebsd.org/cgi/man.cgi?query=ti&sektion=4&format=html) 驱动支持基于 Alteon Tigon I 和 II 芯片。
[ti(4)](https://man.freebsd.org/cgi/man.cgi?query=ti&sektion=4&format=html) 驱动已在以下适配器上测试：
...
[uhso(4)](https://man.freebsd.org/cgi/man.cgi?query=uhso&sektion=4&format=html) 驱动自动将设备从“Zero-CD”模式切换到调制解调器模式。此行为可通过设置 `hw.usb.uhso.auto_switch` 为 0（使用 **sysctl(8)**）来禁用。
...
[xl(4)](https://man.freebsd.org/cgi/man.cgi?query=xl&sektion=4&format=html) 驱动和任何其他 FreeBSD 驱动都不支持此调制解调器。
...
[ipw(4)](https://man.freebsd.org/cgi/man.cgi?query=ipw&sektion=4&format=html)
 驱动支持 Intel PRO/Wireless 2100 MiniPCI 网络适配器。
...
[wpi(4)](https://man.freebsd.org/cgi/man.cgi?query=wpi&sektion=4&format=html)
 驱动支持 Intel PRO/Wireless 3945ABG Mini PCIe 网络适配器。
...
> 包含 7951 芯片，支持对称加密和随机数运算。

Soekris Engineering vpn1401 and vpn1411

> 参见
> *<http://www.soekris.com/>*。
> 包含 7955 芯片，支持对称加密和随机数运算。
