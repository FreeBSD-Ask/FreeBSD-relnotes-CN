...
新增 [efibootmgr(8)](https://www.freebsd.org/cgi/man.cgi?query=efibootmgr&sektion=8&manpath=freebsd-release-ports) 工具，用于操作 EFI 引导管理器。[(r332126)](http://svn.freebsd.org/viewvc/base?view=revision&revision=332126)（由Netflix赞助）
