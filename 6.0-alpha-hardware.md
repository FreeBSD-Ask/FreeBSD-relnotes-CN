# FreeBSD 6.0-RELEASE alpha 硬件兼容性列表
...
完整列表请参阅[英文原文](https://www.freebsd.org/releases/6.0R/hardware-alpha/)。
...
FreeBSD 支持多种磁盘控制器。完整的受支持磁盘控制器列表，请参阅[英文原文](https://www.freebsd.org/releases/6.0R/hardware-alpha/)。

### 3.2 以太网接口

FreeBSD 支持多种以太网接口。完整的受支持设备列表，请参阅[英文原文](https://www.freebsd.org/releases/6.0R/hardware-alpha/)。

### 3.3 其他设备

FreeBSD 还支持各种其他设备。完整的受支持设备列表，请参阅[英文原文](https://www.freebsd.org/releases/6.0R/hardware-alpha/)。
