...
本文档包含 FreeBSD 6.4-RELEASE 在 NEC PC-98x1 硬件平台上的发行说明，介绍了 FreeBSD 最近添加、变更或删除的功能，并提供了从早期版本升级到 FreeBSD 的一些注意事项。
...
以下安全公告中介绍的问题已修复。更多信息请参阅 [http://security.FreeBSD.org/](http://security.freebsd.org/) 提供的各个公告。
