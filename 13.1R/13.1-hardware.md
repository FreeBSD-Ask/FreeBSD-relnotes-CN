...
* 所有 Intel Pentium(R) D 处理器
* 所有 Intel Centrino(R) Duo 和 Centrino(R) Pro 平台
* 采用 "Cedar Mill" 核心的 Intel Pentium(R) 4 和 Celeron(R) D 支持 EM64T
* 部分采用 "Prescott" 核心的 Intel Pentium(R) 4 和 Celeron(R) D 支持 EM64T。关于 Intel 处理器是否支持 EM64T 的权威答案，请参阅 [Intel Processor Spec Finder](http://processorfinder.intel.com)
...
所有自 80486 起的 Intel 处理器均受支持，包括 80486、Pentium(R)、Pentium(R) Pro、Pentium(R) II、Pentium(R) III、Pentium(R) 4 及其变体，如 Xeon(TM) 和 Celeron(R) 处理器。
