...
修复了 **sendmail** 实现的 DNS 映射功能中的编程错误，通过引入新的 **sendmail** 版本修复。更多信息请参阅安全公告 [FreeBSD-SA-03:11](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-03:11.sendmail.asc)。请注意，此功能未在 FreeBSD 提供的默认配置文件中使用。
