...
[4.6.2] 修复了 XDR 解码器中的堆缓冲区溢出漏洞。更多详细信息请参阅安全公告 [FreeBSD-SA-02:34](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-02:34.rpc.asc)。

[4.6.2] 修复了可能允许本地用户在 FFS 文件系统上读取和写入任意块的漏洞。更多详细信息请参阅安全公告 [FreeBSD-SA-02:35](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-02:35.ffs.asc)。
