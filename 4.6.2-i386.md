...
发现 [bzip2(1)](http://www.freebsd.org/cgi/man.cgi?query=bzip2&sektion=1&manpath=FreeBSD+4.6-RELEASE) 工具中的多个漏洞，可能导致文件被意外覆盖或允许本地用户非预期地访问文件。这些问题已通过新的 **bzip2** 导入得到修正。更多信息参见安全公告 [FreeBSD-SA-02:25](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-02:25.bzip2.asc)。

修复了 TCP SYN 缓存（“syncache”）实现中的一个错误，该错误可能在使用接受过滤器（参见 [accept_filter(9)](http://www.freebsd.org/cgi/man.cgi?query=accept_filter&sektion=9&manpath=FreeBSD+4.6-RELEASE)）时使远程攻击者拒绝访问服务。更多信息请参见安全公告 [FreeBSD-SA-02:26](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-02:26.accept.asc)。
...
[4.6.2] 修复了解析器中的缓冲区溢出漏洞，该漏洞可能被恶意域名服务器或伪造 DNS 消息的攻击者利用。更多信息请参见安全公告 [FreeBSD-SA-02:28](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-02:28.resolv.asc)。
...
[4.6.2] 修复了 [ktrace(1)](http://www.freebsd.org/cgi/man.cgi?query=ktrace&sektion=1&manpath=FreeBSD+4.6-RELEASE) 的问题，该问题可能允许跟踪以前有特权的进程的操作，进而泄漏敏感信息。更多信息请参见安全公告 [FreeBSD-SA-02:30](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-02:30.ktrace.asc)。

[4.6.2] 修复了 [pppd(8)](http://www.freebsd.org/cgi/man.cgi?query=pppd&sektion=8&manpath=FreeBSD+4.6-RELEASE) 中的竞争条件漏洞，该漏洞可能被用来变更任意文件的权限。更多信息请参见安全公告 [FreeBSD-SA-02:32](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-02:32.pppd.asc)。
