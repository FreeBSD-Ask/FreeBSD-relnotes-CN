...
[newfs(8)](https://www.freebsd.org/cgi/man.cgi?query=newfs&sektion=8&manpath=freebsd-release-ports) 和 [tunefs(8)](https://www.freebsd.org/cgi/man.cgi?query=tunefs&sektion=8&manpath=freebsd-release-ports) 工具已更新，允许标签名称中使用下划线。[(r343538)](http://svn.freebsd.org/viewvc/base?view=revision&revision=343538)（由Netflix赞助）
