...
本软件最初派生自 William F. Jolitz 的 386BSD 0.1 版本，但几乎所有的 386BSD 特定代码都已不复存在。本软件基本上是在加州大学伯克利分校计算机系统研究组（CSRG）的 4.4 BSD Lite 基础上重新实现的，同时也包含了相关学术贡献者的工作。
...
特别感谢 Walnut Creek CDROM 提供了用于开发工作的 486/DX2-66 EISA/VL 系统，更不用说网络接入和其他硬件资源的捐赠。没有他们的支持，完成这一版本几乎是不可能的。
