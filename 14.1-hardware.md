...
WORM/CD-R/CD-RW 写入支持由 [cdrecord(1)](https://man.freebsd.org/cgi/man.cgi?query=cdrecord&sektion=1&format=html) 提供，该工具是 Ports 中 package:sysutils/cdrtools[] port 的一部分。
