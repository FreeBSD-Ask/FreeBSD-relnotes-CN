...
- 引导加载程序的更改允许从 USB 设备引导以及从 GPT 标签的磁盘引导等。
...
许多公司捐赠了设备、网络访问权限或人力时间来支持 FreeBSD 7.1 的发行工程活动，包括 The FreeBSD Foundation、FreeBSD Systems、Hewlett-Packard、Yahoo!、Network Appliances 和 Sentex Communications。
