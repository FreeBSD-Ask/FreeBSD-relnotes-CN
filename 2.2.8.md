...
- **处理了自 2.2.7 发布以来所有公开的 CERT/Bugtraq 安全公告**。
...
此外，由于这是一个志愿者项目，我们始终欢迎更多愿意帮助的人的加入——目前所需的增强功能远远超过我们自己能完成的！如需就技术问题联系我们，或提供帮助，请发送邮件至：`freebsd-hackers@FreeBSD.org`
...
FreeBSD 凝聚了来自世界各地许多个人的共同努力，这些人不懈工作，最终为你带来了这个版本。欲查看完整的 FreeBSD 项目工作人员名单，请访问：[http://www.FreeBSD.org/handbook/staff.html](http://www.FreeBSD.org/handbook/staff.html)
