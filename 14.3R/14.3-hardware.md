...
[ti(4)](https://man.freebsd.org/cgi/man.cgi?query=ti&sektion=4&format=html) 驱动支持基于 Alteon Tigon I and II chips.
...
该设备具有一个称为 “Zero-CD” which contains drivers for Microsoft Windows; this is the default mode for the device.
[uhso(4)](https://man.freebsd.org/cgi/man.cgi?query=uhso&sektion=4&format=html) 驱动自动将设备从 “Zero-CD” mode to modem mode. 此行为可通过设置 *hw.usb.uhso.auto_switch* to 0 using sysctl(8).
