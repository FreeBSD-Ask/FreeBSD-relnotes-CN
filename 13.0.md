...
新增的驱动程序 [ossl(4)](https://man.freebsd.org/cgi/man.cgi?query=ossl&sektion=4&format=html) 支持在 aarch64、amd64 和 i386 上使用 OpenSSL 的汇编例程进行优化的软件加密。[ba610be90a7c](https://cgit.freebsd.org/src/commit/?id=ba610be90a7c)（由Netflix赞助）， [22bd0c9731d7](https://cgit.freebsd.org/src/commit/?id=22bd0c9731d7)（由 FreeBSD 基金会赞助）
