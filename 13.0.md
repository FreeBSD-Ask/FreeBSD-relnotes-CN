...
amd64 的 DMAR 驱动程序已重构，为其他架构提供了通用的 I/O MMU 框架。作为此重构的一部分，amd64 特定的 **ACPI_DMAR** 内核选项已重命名为 **IOMMU**。[6186bfbd1880](https://cgit.freebsd.org/src/commit/?id=6186bfbd1880)（由 DARPA, AFRL 赞助）
