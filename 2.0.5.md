...
自 2.0 版本以来，原始的 274x/284x 驱动已做了大量改进。现在我们全面支持 2940 系列以及这些卡的 WIDE 型号。修复了导致驱动在快速设备上出现问题的仲裁错误（以及其他许多错误），并且还支持实验性的标记排队（内核选项 **AHC_TAGENABLE**）。John Aycock 还发布了序列器代码，采用“伯克利风格”版权，使得驱动完全不受 GPL 的影响。
