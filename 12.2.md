...
FreeBSD 12.2-RELEASE 的发行说明包含了 FreeBSD 基本系统在 12-STABLE 开发线上的变更摘要。本文档列出了自上一个版本以来发布的适用的安全公告，以及 FreeBSD 内核和用户空间的重大变更。还简要介绍了升级过程。
...
所有用户在安装 FreeBSD 之前都被鼓励查阅发布勘误。该勘误会在发布周期结束时或发布后更新，提供“最新”信息。通常，它包含已知的错误、安全公告和文档修正。可以在 FreeBSD 网站上找到最新的 FreeBSD 12.2-RELEASE 勘误副本。
