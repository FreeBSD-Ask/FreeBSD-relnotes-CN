...
你可以从 `ftp.FreeBSD.org` - 官方的 FreeBSD 发布站点，下载 FreeBSD 及其所有或部分可选软件包。
...
请注意，`send-pr` 本身是个 shell 脚本，即使移植到完全不同的系统上也能轻松运行。我们更希望你能使用这种接口，因为它有助于更容易地跟踪问题报告。然而，在提交报告之前，请确认该问题是否在此期间修复完成。
