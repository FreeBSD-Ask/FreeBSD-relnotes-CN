...
FreeBSD 凝聚了来自全球数十甚至数百位个人的辛勤努力，他们为使这次发布成为现实付出了极大的努力。列举所有为 FreeBSD 做出贡献的人是非常困难的，甚至几乎是不可能的，但我们仍然会尝试（按字母顺序排列，当然）。如果你为我们做出了实质性的贡献，但你的名字没有出现在此，请放心，遗漏完全是偶然的。如果你希望更新以下列表，请联系 <hackers@FreeBSD.org>：
