...
FreeBSD 的核心不包含会妨碍其出口到美国以外地区的 DES 代码。对于仅在美国使用的用户，有一个附加包，包含了通常使用 DES 的程序。单独提供的辅助包任何人都可以使用。我们还为非美国用户提供了一个可以自由出口的 DES 版本，位于 [ftp://ftp.internat.FreeBSD.org/pub/FreeBSD](ftp://ftp.internat.FreeBSD.org/pub/FreeBSD)。
...
此外，由于这是一个志愿者项目，我们非常欢迎愿意提供帮助的额外力量——目前有更多的需求和功能改进，超出了我们单独处理的能力！如果你希望就技术问题与我们联系，或提供帮助，请发送邮件至：`hackers@FreeBSD.org`
