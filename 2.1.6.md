...
**注意**：由于 SoundBlaster 卡没有板载 BIOS，无法从中启动，这对于将启动设备映射到系统 BIOS I/O 向量是必要的。然而，它们完全可以用于外部磁带、CD-ROM 等。其他没有启动 ROM 的 AIC-6x60 系列卡也是如此。某些系统确实配有启动 ROM，通常在系统首次启动或重置时会显示相关信息，在这种情况下你也可以从中启动。请查看你的系统/主板文档以了解更多细节。
