...
FreeBSD 12.1-RELEASE 预计还将在 Google Compute Engine(TM) Marketplace 中提供，待其完成第三方特定验证后，访问：
...
基于对 FreeBSD 支持模型审查的讨论，FreeBSD 12 发行系列将至少支持至 2020 年 11 月 30 日。更多信息，请参阅关于支持模型即将进行的讨论的[官方公告](https://lists.freebsd.org/pipermail/freebsd-announce/2018-November/001854.html)。
