...
使用较旧 Broadcom 芯片组（BCM4301、BCM4303 和 BCM4306 rev 2）的用户必须使用 **bwi(4)**，因为固件的 v4 版本不支持这些芯片。
较新的固件过大，无法放入这些旧芯片。
...
[ucycom(4)](https://man.freebsd.org/cgi/man.cgi?query=ucycom&sektion=4&format=html)
 驱动目前支持以下包含 Cypress USB 到 RS232 桥接芯片的设备：
...
> 包含 7951，支持对称运算和随机数运算。

Soekris Engineering vpn1401 和 vpn1411

> 参见
> *<http://www.soekris.com/>*。
> 包含 7955，支持对称运算和随机数运算。
...
> 有关在 Xorg 中使用指针设备的信息，请参阅 [http://www.x.org/](http://www.x.org/)。
