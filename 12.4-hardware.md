...
[adv(4)](https://man.freebsd.org/cgi/man.cgi?query=adv&sektion=4&format=html) 驱动支持以下 SCSI controllers：
...
[adw(4)](https://man.freebsd.org/cgi/man.cgi?query=adw&sektion=4&format=html) 驱动支持 SCSI controllers，包括：
...
[aha(4)](https://man.freebsd.org/cgi/man.cgi?query=aha&sektion=4&format=html) 驱动支持以下 SCSI host adapters：
...
[ahc(4)](https://man.freebsd.org/cgi/man.cgi?query=ahc&sektion=4&format=html) 驱动支持以下 SCSI host adapter chips and SCSI controller cards：
...
[arcmsr(4)](https://man.freebsd.org/cgi/man.cgi?query=arcmsr&sektion=4&format=html) 驱动支持以下 cards：
...
[bt(4)](https://man.freebsd.org/cgi/man.cgi?query=bt&sektion=4&format=html) 驱动支持以下 BusLogic MultiMaster “W”, “C”, “S”, and “A” series and compatible SCSI host adapters：
...
[hpt27xx(4)](https://man.freebsd.org/cgi/man.cgi?query=hpt27xx&sektion=4&format=html) 驱动支持以下 SAS controllers：
...
[hptiop(4)](https://man.freebsd.org/cgi/man.cgi?query=hptiop&sektion=4&format=html) 驱动支持以下 SAS and SATA RAID controllers：
...
[hptmv(4)](https://man.freebsd.org/cgi/man.cgi?query=hptmv&sektion=4&format=html) 驱动支持以下 ATA RAID controllers：

* HighPoint's RocketRAID 182x series

[hptrr(4)](https://man.freebsd.org/cgi/man.cgi?query=hptrr&sektion=4&format=html) 驱动支持以下 RAID controllers：
...
[mfi(4)](https://man.freebsd.org/cgi/man.cgi?query=mfi&sektion=4&format=html) 驱动支持以下 hardware：
...
[mrsas(4)](https://man.freebsd.org/cgi/man.cgi?query=mrsas&sektion=4&format=html) 驱动支持以下 hardware：
...
[mvs(4)](https://man.freebsd.org/cgi/man.cgi?query=mvs&sektion=4&format=html) 驱动支持以下 controllers：
...
[pms(4)](https://man.freebsd.org/cgi/man.cgi?query=pms&sektion=4&format=html) 驱动支持以下 hardware：
...
[pst(4)](https://man.freebsd.org/cgi/man.cgi?query=pst&sektion=4&format=html) 驱动支持 the Promise Supertrak SX6000 ATA hardware RAID controller。

[siis(4)](https://man.freebsd.org/cgi/man.cgi?query=siis&sektion=4&format=html) 驱动支持以下 controller chips：
...
[twa(4)](https://man.freebsd.org/cgi/man.cgi?query=twa&sektion=4&format=html) 驱动支持以下 SATA RAID controllers：
...
[twe(4)](https://man.freebsd.org/cgi/man.cgi?query=twe&sektion=4&format=html) 驱动支持以下 PATA/SATA RAID controllers：
...
[tws(4)](https://man.freebsd.org/cgi/man.cgi?query=tws&sektion=4&format=html) 驱动支持以下 SATA/SAS RAID controller：

* LSI's 3ware SAS 9750 series

[vpo(4)](https://man.freebsd.org/cgi/man.cgi?query=vpo&sektion=4&format=html) 驱动支持以下 parallel to SCSI interfaces：
...
[ed(4)](https://man.freebsd.org/cgi/man.cgi?query=ed&sektion=4&format=html) 驱动支持以下 Ethernet NICs：
...
[ex(4)](https://man.freebsd.org/cgi/man.cgi?query=ex&sektion=4&format=html) 驱动支持以下 Ethernet adapters：
...
[hme(4)](https://man.freebsd.org/cgi/man.cgi?query=hme&sektion=4&format=html) 驱动支持 the on-board Ethernet interfaces of many Sun UltraSPARC workstation and server models。
...
[ixgbe(4)](https://man.freebsd.org/cgi/man.cgi?query=ixgbe&sektion=4&format=html) 驱动支持以下 cards：
...
[mlx4en(4)](https://man.freebsd.org/cgi/man.cgi?query=mlx4en&sektion=4&format=html) 驱动支持以下 network adapters：
...
[nfe(4)](https://man.freebsd.org/cgi/man.cgi?query=nfe&sektion=4&format=html) 驱动支持以下 NVIDIA MCP onboard adapters：
...
[oce(4)](https://man.freebsd.org/cgi/man.cgi?query=oce&sektion=4&format=html) 驱动支持以下 network adapters：
...
[re(4)](https://man.freebsd.org/cgi/man.cgi?query=re&sektion=4&format=html) 驱动支持 RealTek RTL8139C+, RTL8169, RTL816xS, RTL811xS, RTL8168, RTL810xE and RTL8111 based Fast Ethernet and Gigabit Ethernet adapters，包括：
...
[rue(4)](https://man.freebsd.org/cgi/man.cgi?query=rue&sektion=4&format=html) 驱动支持 RealTek RTL8150 based USB Ethernet adapters，包括：
...
[sfxge(4)](https://man.freebsd.org/cgi/man.cgi?query=sfxge&sektion=4&format=html) 驱动支持 all 10Gb Ethernet adapters based on Solarflare SFC9000 family controllers。
...
[sn(4)](https://man.freebsd.org/cgi/man.cgi?query=sn&sektion=4&format=html) 驱动支持 SMC91Cxx based ISA and PCMCIA cards，包括：
...
[sn(4)](https://man.freebsd.org/cgi/man.cgi?query=sn&sektion=4&format=html) 驱动支持 the SMC 91C90, SMC 91C92, SMC 91C94, SMC 91C95, SMC 91C96, SMC91C100 and SMC 91C100FD chips from SMC。
...
[ste(4)](https://man.freebsd.org/cgi/man.cgi?query=ste&sektion=4&format=html) 驱动支持 Sundance Technologies ST201 based Fast Ethernet adapters and embedded controllers，包括：
...
[txp(4)](https://man.freebsd.org/cgi/man.cgi?query=txp&sektion=4&format=html) 驱动支持以下 cards：
...
[udav(4)](https://man.freebsd.org/cgi/man.cgi?query=udav&sektion=4&format=html) 驱动支持以下 adapters：

* Corega FEther USB-TXC
* ShanTou ST268 USB NIC

[urndis(4)](https://man.freebsd.org/cgi/man.cgi?query=urndis&sektion=4&format=html) 驱动支持 the functionality of many Android devices。

[vge(4)](https://man.freebsd.org/cgi/man.cgi?query=vge&sektion=4&format=html) 驱动支持 VIA Networking VT6120, VT6122, VT6130 and VT6132 based Gigabit Ethernet adapters，包括：

* VIA Networking LAN-on-motherboard Gigabit Ethernet
* ZyXEL GN650-T 64-bit PCI Gigabit Ethernet NIC (ZX1701)
* ZyXEL GN670-T 32-bit PCI Gigabit Ethernet NIC (ZX1702)

[vr(4)](https://man.freebsd.org/cgi/man.cgi?query=vr&sektion=4&format=html) 驱动支持 VIA Technologies Rhine I, Rhine II, and Rhine III based Fast Ethernet adapters，包括：
...
[vx(4)](https://man.freebsd.org/cgi/man.cgi?query=vx&sektion=4&format=html) 驱动支持以下 cards：

* 3Com 3c590 EtherLink III PCI
* 3Com 3c595 Fast EtherLink III PCI in 10 Mbps mode

[wb(4)](https://man.freebsd.org/cgi/man.cgi?query=wb&sektion=4&format=html) 驱动支持 Winbond W89C840F based Fast Ethernet adapters and embedded controllers，包括：

* Trendware TE100-PCIE

[xe(4)](https://man.freebsd.org/cgi/man.cgi?query=xe&sektion=4&format=html) 驱动支持以下 cards：
...
[xl(4)](https://man.freebsd.org/cgi/man.cgi?query=xl&sektion=4&format=html) 驱动支持以下 hardware：
...
[ath(4)](https://man.freebsd.org/cgi/man.cgi?query=ath&sektion=4&format=html) 驱动支持 all Atheros Cardbus and PCI cards, except those that are based on the AR5005VL chipset。
...
[bwn(4)](https://man.freebsd.org/cgi/man.cgi?query=bwn&sektion=4&format=html) 驱动支持 Broadcom BCM43xx based wireless devices，包括：
...
[ral(4)](https://man.freebsd.org/cgi/man.cgi?query=ral&sektion=4&format=html) 驱动支持 PCI/PCIe/CardBus wireless adapters based on Ralink Technology chipsets，包括：
...
[rum(4)](https://man.freebsd.org/cgi/man.cgi?query=rum&sektion=4&format=html) 驱动支持 USB 2.0 wireless adapters based on the Ralink RT2501USB and RT2601USB chipsets，包括：
...
[run(4)](https://man.freebsd.org/cgi/man.cgi?query=run&sektion=4&format=html) 驱动支持以下 wireless adapters：
...
[ural(4)](https://man.freebsd.org/cgi/man.cgi?query=ural&sektion=4&format=html) 驱动支持 USB 2.0 wireless adapters based on the Ralink Technology RT2500USB chipset，包括：
...
[urtw(4)](https://man.freebsd.org/cgi/man.cgi?query=urtw&sektion=4&format=html) 驱动支持 Realtek RTL8187B/L based wireless network devices，包括：
...
[ce(4)](https://man.freebsd.org/cgi/man.cgi?query=ce&sektion=4&format=html) 驱动支持以下 models of Tau-PCI/32 WAN adapters：

* Cronyx Tau-PCI/32
* Cronyx Tau-PCI/32-Lite

[cx(4)](https://man.freebsd.org/cgi/man.cgi?query=cx&sektion=4&format=html) 驱动支持以下 cards：
...
[cp(4)](https://man.freebsd.org/cgi/man.cgi?query=cp&sektion=4&format=html) 驱动支持以下 models of Tau-PCI WAN adapters：
...
[ctau(4)](https://man.freebsd.org/cgi/man.cgi?query=ctau&sektion=4&format=html) 驱动支持以下 cards：
...
[rc(4)](https://man.freebsd.org/cgi/man.cgi?query=rc&sektion=4&format=html) 驱动为 the SDL Communications RISCom/8 boards 提供支持。

### 声音设备

[snd_ad1816(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_ad1816&sektion=4&format=html) 驱动支持以下 sound cards：

* Analog Devices AD1816

[snd_als4000(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_als4000&sektion=4&format=html) 驱动支持以下 sound cards：

* Avance Logic ALS4000

[snd_atiixp(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_atiixp&sektion=4&format=html) 驱动支持以下 audio chipsets：

* ATI IXP 200
* ATI IXP 300
* ATI IXP 400

[snd_audiocs(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_audiocs&sektion=4&format=html) 驱动支持以下 audio devices：

* CS4231 on SBus based UltraSPARC
* CS4231 on PCI/EBus based UltraSPARC

[snd_cmi(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_cmi&sektion=4&format=html) 驱动支持以下 sound cards：
...
[snd_cs4281(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_cs4281&sektion=4&format=html) 驱动支持以下 sound cards：

* Crystal Semiconductor CS4281

[snd_csa(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_csa&sektion=4&format=html) 驱动支持以下 sound cards：
...
[snd_ds1(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_ds1&sektion=4&format=html) 驱动支持以下 sound cards：

* Yamaha DS-1
* Yamaha DS-1E

[snd_emu10k1(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_emu10k1&sektion=4&format=html) 驱动支持以下 sound cards：
...
[snd_emu10kx(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_emu10kx&sektion=4&format=html) 驱动支持以下 sound cards：
...
[snd_envy24(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_envy24&sektion=4&format=html) 驱动支持以下 audio devices：
...
[snd_envy24ht(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_envy24ht&sektion=4&format=html) 驱动支持以下 audio devices：
...
[snd_es137x(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_es137x&sektion=4&format=html) 驱动支持以下 sound cards：
...
[snd_ess(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_ess&sektion=4&format=html) 驱动支持以下 sound cards：
...
[snd_gusc(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_gusc&sektion=4&format=html) 驱动支持以下 sound cards：

* Gravis UltraSound MAX
* Gravis UltraSound PnP

[snd_hda(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_hda&sektion=4&format=html) 驱动支持 controllers having PCI class 4 (multimedia) and subclass 3 (HDA), compatible with Intel HDA specification。

[snd_hda(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_hda&sektion=4&format=html) 驱动支持 more than two hundred different controllers and CODECs. There is no sense to list all of them here, as in most cases specific CODEC configuration and wiring are more important then type of the CODEC itself。

[snd_hdspe(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_hdspe&sektion=4&format=html) 驱动支持以下 audio devices：

* RME HDSPe AIO
* RME HDSPe RayDAT

[snd_ich(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_ich&sektion=4&format=html) 驱动支持以下 audio devices：
...
[snd_maestro(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_maestro&sektion=4&format=html) 驱动支持以下 PCI sound cards：

* ESS Technology Maestro-1
* ESS Technology Maestro-2
* ESS Technology Maestro-2E

[snd_maestro3(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_maestro3&sektion=4&format=html) 驱动支持以下 audio devices：

* ESS Technology Allegro-1
* ESS Technology Maestro3

[snd_mss(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_mss&sektion=4&format=html) 驱动支持以下 audio devices：
...
[snd_neomagic(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_neomagic&sektion=4&format=html) 驱动支持以下 audio devices：

* NeoMagic 256AV
* NeoMagic 256ZX

[snd_sbc(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_sbc&sektion=4&format=html) 驱动支持以下 sound cards：
...
[snd_solo(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_solo&sektion=4&format=html) 驱动支持以下 sound cards：
...
[snd_spicds(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_spicds&sektion=4&format=html) 驱动支持以下 codecs：
...
[snd_t4dwave(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_t4dwave&sektion=4&format=html) 驱动支持以下 audio devices：
...
[snd_via8233(4)](https://man.freebsd.org/cgi/man.cgi?query=snd_via8233&sektion=4&format=html) 驱动支持以下 audio chipsets：
...
[bktr(4)](https://man.freebsd.org/cgi/man.cgi?query=bktr&sektion=4&format=html) 驱动支持 video capture cards based on the Brooktree Bt848/849/878/879 chips, as well as Pinnacle PCTV cards，包括：
...
[ohci(4)](https://man.freebsd.org/cgi/man.cgi?query=ohci&sektion=4&format=html) 驱动支持 all OHCI v1.0 compliant controllers，包括：
...
[uhci(4)](https://man.freebsd.org/cgi/man.cgi?query=uhci&sektion=4&format=html) 驱动支持 all UHCI v1.1 compliant controllers，包括：
...
[ubsa(4)](https://man.freebsd.org/cgi/man.cgi?query=ubsa&sektion=4&format=html) 驱动支持以下 adapters：
...
[ubser(4)](https://man.freebsd.org/cgi/man.cgi?query=ubser&sektion=4&format=html) 驱动为 the BWCT console management serial adapters 提供支持。

[uftdi(4)](https://man.freebsd.org/cgi/man.cgi?query=uftdi&sektion=4&format=html) 驱动支持以下 adapters：
...
[uplcom(4)](https://man.freebsd.org/cgi/man.cgi?query=uplcom&sektion=4&format=html) 驱动支持以下 devices and adapters：
...
[umct(4)](https://man.freebsd.org/cgi/man.cgi?query=umct&sektion=4&format=html) 驱动支持以下 adapters：
...
[uvisor(4)](https://man.freebsd.org/cgi/man.cgi?query=uvisor&sektion=4&format=html) 驱动支持以下 devices：
...
[ng_bt3c(4)](https://man.freebsd.org/cgi/man.cgi?query=ng_bt3c&sektion=4&format=html) 驱动为 the 3Com/HP 3CRWB6096-A PCCARD bluetooth adapter 提供支持。

[ng_ubt(4)](https://man.freebsd.org/cgi/man.cgi?query=ng_ubt&sektion=4&format=html) 驱动支持 all Bluetooth USB devices that conform with the Bluetooth specification v1.1，包括：
