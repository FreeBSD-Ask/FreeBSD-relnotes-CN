...
这些发行注记所对应的“RELEASE”发行版，代表 15-STABLE 开发分支上介于 14.0-RELEASE 与后续 15.1-RELEASE 之间的最新节点。可在 [https://www.FreeBSD.org/releases/](https://www.freebsd.org/releases/) 找到关于此分支上预构建二进制“RELEASE”发行版的信息。要获取此（或其他）FreeBSD“RELEASE”发行版的更多信息，可参阅 [FreeBSD 手册](https://docs.freebsd.org/en/books/handbook/) 的附录[获取 FreeBSD](https://docs.freebsd.org/en/books/handbook/mirrors)。
