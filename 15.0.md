...
系统废弃了 [sound(4)](https://man.freebsd.org/cgi/man.cgi?query=sound&sektion=4&format=html) 中的 `unit.*` 代码，作为其中一部分，还移除了 [loader(8)](https://man.freebsd.org/cgi/man.cgi?query=loader&sektion=8&format=html) 可调项 `hw.snd.maxunit`。[25723d66369f](https://cgit.freebsd.org/src/commit/?id=25723d66369f)（由 FreeBSD 基金会赞助）
