...
现在在 aarch64 和 amd64 上，通过 LinuxBoot 启动加载器可以从 Linux 启动 FreeBSD。[46010641267](https://cgit.freebsd.org/src/commit/?id=46010641267) **（由 Netflix 赞助）**
