...
在 EFI 系统上，改进了 [loader(8)](https://man.freebsd.org/cgi/man.cgi?query=loader&sektion=8&format=html) 的控制台检测。如果没有 ConOut 变量，则检查 ConIn；如果发现多个设备，则优先使用串口设备。[20a6f4779ac6](https://cgit.freebsd.org/src/commit/?id=20a6f4779ac6) **（由 Netflix 赞助）**
