...
添加了的内核配置选项 `EM_MULTIQUEUE`，它启用 [em(4)](http://www.freebsd.org/cgi/man.cgi?query=em&sektion=4&manpath=freebsd-release-ports) 驱动程序的多队列支持。[(r283959)](http://svn.freebsd.org/viewvc/base?view=revision&revision=283959)（由 Limelight Networks 赞助）
