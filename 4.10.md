...
此发行版的 FreeBSD 4.10-RELEASE 是一个发行版。它可以在 [ftp://ftp.FreeBSD.org/](ftp://ftp.freebsd.org/) 或其镜像站点找到。有关获取此（或其他）FreeBSD 发行版的更多信息，请参见 [FreeBSD 手册](http://www.freebsd.org/doc/en_US.ISO8859-1/books/handbook/) 中的 [`获取 FreeBSD`](http://www.freebsd.org/doc/en_US.ISO8859-1/books/handbook/mirrors.html) 附录。
