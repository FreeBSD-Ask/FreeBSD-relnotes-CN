...
发布后发现的重要信息或最后一刻变更，详见 [勘误](http://www.freebsd.org/releases/4.10R/勘误.html) 文档。

## 2 新特性

本节介绍了自 4.9-RELEASE 以来 FreeBSD 中最显著的用户可见新特性或变更。典型的发行说明项目记录了新驱动程序或硬件支持、新命令或选项、主要的 bug 修复，或第三方软件更新。还列出了自 4.9-RELEASE 之后发布的与基本系统相关的安全公告。

### 2.1 安全公告

已修复 **BIND** 中的潜在拒绝服务漏洞。更多信息请参见安全公告 [FreeBSD-SA-03:19](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-03:19.bind.asc)。
...
**Heimdal** 的一个 bug 修复了它在跨自治领域进行身份验证时未进行充分检查的问题。更多信息请参见安全公告 [FreeBSD-SA-04:08](ftp://ftp.freebsd.org/pub/FreeBSD/CERT/advisories/FreeBSD-SA-04:08.heimdal.asc)。
