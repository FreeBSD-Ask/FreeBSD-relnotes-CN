...
在安装 FreeBSD 之前，所有用户都应查看发布勘误。勘误 文档会更新“临时突发”信息，这些信息是在发布周期的后期或发布后发现的。通常，它包含已知的 bug、相关的安全公告以及文档的修正。FreeBSD 7.3-RELEASE 的勘误的最新版本可以在 [http://www.FreeBSD.org/releases/7.3R/errata.html](http://www.freebsd.org/releases/7.3R/勘误.html) 找到。
