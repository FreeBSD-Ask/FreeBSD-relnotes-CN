...
鼓励所有用户在安装 FreeBSD 之前查阅发行说明的附录。附录文档包含了发布周期结束或发布后发现的“最后时刻”信息。通常，它包含已知的漏洞、安全公告以及文档的修正。有关 FreeBSD 6.0-RELEASE 的更新版附录，可以在 FreeBSD 网站上找到。
...
[ipw(4)](http://www.freebsd.org/cgi/man.cgi?query=ipw&sektion=4&manpath=FreeBSD+6.0-RELEASE)（适用于 Intel PRO/Wireless 2100）、[iwi(4)](http://www.freebsd.org/cgi/man.cgi?query=iwi&sektion=4&manpath=FreeBSD+6.0-RELEASE)（适用于 Intel PRO/Wireless 2200BG/2225BG/2915ABG）、[ral(4)](http://www.freebsd.org/cgi/man.cgi?query=ral&sektion=4&manpath=FreeBSD+6.0-RELEASE)（适用于 Ralink Technology RT2500）和 [ural(4)](http://www.freebsd.org/cgi/man.cgi?query=ural&sektion=4&manpath=FreeBSD+6.0-RELEASE)（适用于 Ralink Technology RT2500USB）驱动。
