...
本发行说明适用于“发行版”（release distribution），此 RELEASE 代表了开发分支 13-STABLE 自创建以来的最新状态。有关此分支上预编译的二进制“发行版”的信息，请访问 [https://www.FreeBSD.org/releases/](https://www.freebsd.org/releases/)。  
