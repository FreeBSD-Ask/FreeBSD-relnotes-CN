...
新增了内核模块 [lomac(4)](http://www.freebsd.org/cgi/man.cgi?query=lomac&sektion=4&manpath=FreeBSD+5.0-RELEASE)，这是一个低水印强制访问控制安全机制，作为传统 UID 基安全设施的补充。无需管理员额外配置即可使用。美国国防高级研究计划局和 NAI Labs 赞助了此功能的开发。
